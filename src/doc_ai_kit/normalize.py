...
abstention. It never decides whether two values match -- that is :mod:`doc_ai_kit.match`.
...
from doc_ai_kit.hooks import register_normalizer
from doc_ai_kit.values import Granularity, PartialDate, Quantity, QuotedSpan, Span
