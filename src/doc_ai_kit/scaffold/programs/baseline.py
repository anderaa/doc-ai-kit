...
The package records three baselines: zero-shot, hand-written few-shot, and BootstrapFewShot.
...
def hand_written_demos(examples: Sequence[Any]) -> Mapping[str, Sequence[Any]]:
    ...
    Return an empty mapping to skip the few-shot baseline; the package will say so loudly
