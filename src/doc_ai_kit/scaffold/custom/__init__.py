...
enough to make it available by name in tasks.yaml and config.yaml. The installed doc_ai_kit
...
Example::
    ...
    from doc_ai_kit.normalize import collapse_whitespace, fold_unicode
