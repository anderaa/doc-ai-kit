...
from doc_harness.hooks import get_normalizer, register_matcher
from doc_harness.values import (
    Granularity,
    MatchResult,
    PartialDate,
    Quantity,
...
def numeric(gold: Any, pred: Any, params: Mapping[str, Any]) -> MatchResult:
    ...
    Differing units are a mismatch rather than a conversion: the harness will not guess an
