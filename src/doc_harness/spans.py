...
passage verbatim and the harness finds it in the text.
...
from doc_harness.normalize import fold_unicode, strip_wrapping_quotes
from doc_harness.values import Span
